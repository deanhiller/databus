...
public class MySchemas extends Controller {
	...
	public static void viewSchema(String schemaName) {
		EntityUser user = Utility.getCurrentUser(session);
	...
	public static void editSchema(String schemaName) {
		EntityUser user = Utility.getCurrentUser(session);
	...
	private static void newSchema(SecureSchema schema) {
	...
	private static void modifyOldSchema(SecureSchema schema, String oldSchemaName) {
	...
	public static void postAddGroupToSchema(SecureSchema schema, EntityGroup targetGroup, String permission) {
		...
		MySchemas.editSchema(schema.getSchemaName());
	}
	
	public static void postAddUserToSchema(SecureSchema schema, EntityUser targetUser, String permission) {
	...
	public static void postAddTableToSchema(SecureSchema schema, SecureResource targetTable) {
	...
	public static void postSchema(SecureSchema schema, String oldSchemaName) {
		if(StringUtils.isEmpty(oldSchemaName)) {
			newSchema(schema);
		} else 
			modifyOldSchema(schema, oldSchemaName);
	...
	public static void postMonitor(String schema, TableMonitor monitor) {
		...
		if(validation.hasErrors()) {
			render("@monitorAdd", schemaDbo, monitor);
			return;
		}
