(function ($) {
	AjaxSolr.CurrentPagerWidget = AjaxSolr.PagerWidget.extend({
		...
		afterRequest: function () {
			...
			var totalCount = GlobalManager.response.response.numFound;
			var totalShown = GlobalManager.response.response.docs.length;
			var startIndex = GlobalManager.response.response.start;
