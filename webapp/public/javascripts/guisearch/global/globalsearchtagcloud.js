	...
	AjaxSolr.TagcloudWidget = AjaxSolr.AbstractFacetWidget.extend({
		afterRequest: function () {
			...
			for (var i in facetItems) {
				...
				var tagWidget = null;
				if(GlobalManager.widgets.hasOwnProperty(facetItem)) {
					tagWidget = GlobalManager.widgets[facetItem];
				} else {
				...
				GlobalManager.addWidget(tagWidget);
				...
				*/
				...
				var accordionBodyDiv = $('<div id="collapse_' + facetItem + '" class="accordion-body collapse" style="height: 0px;">');
				var innerAccordionBodyDiv = $('<div class="accordion-inner">');
				var facetBodyDiv = $('<div id="_' + facetItem + '">');
				...
				tableLinksAnchor.click(function() {
					...
					if($(element).hasClass("icon-chevron-down")) {
						...
						var collapser = $("#collapse_" + facetItem);
						collapser.css({"height": "0px"});
					} else {
