(function ($) {
	AjaxSolr.CurrentPagerWidget = AjaxSolr.PagerWidget.extend({
		...
		afterRequest: function () {
			...
			var totalCount = IsSearchableManager.response.response.numFound;
			var totalShown = IsSearchableManager.response.response.docs.length;
			var startIndex = IsSearchableManager.response.response.start;
