(function ($) {
	AjaxSolr.CurrentPagerWidget = AjaxSolr.PagerWidget.extend({
		...
		afterRequest: function () {
			...
			var totalCount = MetaManager.response.response.numFound;
			var totalShown = MetaManager.response.response.docs.length;
			var startIndex = MetaManager.response.response.start;
