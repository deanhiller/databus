...
(function ($) {
    ...
    $.fn.fixedHeaderTable = function (method) {
		...
		if (settings.width.search('%') > -1) {
		    var widthMinusScrollbar = $self.parent().width() - settings.scrollbarOffset - 10;
		} else {
		    var widthMinusScrollbar = settings.width - settings.scrollbarOffset - 10;				
		}
            ...
            _setupClone: function($obj, cellArray) {
                ...
                $self.find(selector).each(function(index) {
                    ...
                    if (!$(this).closest('.fht-tbody').length && $(this).is(':last-child') && !$(this).closest('.fht-fixed-column').length) {
                    	var padding = (($(this).innerWidth() - $(this).width()) / 2) + settings.scrollbarOffset + 8;
                    	
                    	var parentDiv = $(this).closest('.fht-table-wrapper')[0];
                    	
                    	if(parentDiv != undefined) {
	                    	var hasVerticalScrollbar = parentDiv.scrollHeight > parentDiv.clientHeight;
                ...
                var thCells = $self.find('thead').find('div').attr('style');
            },
